...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { about: @artwork.about, cover: @artwork.cover, name: @artwork.name } }
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { about: @artwork.about, cover: @artwork.cover, name: @artwork.name } }
