...
class ExhibitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exhibition" do
    assert_difference('Exhibition.count') do
      post exhibitions_url, params: { exhibition: { about: @exhibition.about, cover: @exhibition.cover, name: @exhibition.name } }
    end
  ...
  test "should update exhibition" do
    patch exhibition_url(@exhibition), params: { exhibition: { about: @exhibition.about, cover: @exhibition.cover, name: @exhibition.name } }
